...
Primary low-cost qualitative reasoning engine with prompt-injection protection.
"""
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                return {
                    ...
                    "approved": True,
                    "confidence": 0.70,
                    "reasoning": f"DeepSeek API HTTP {res.status_code} fallback. Deterministic rules passed.",
                    "supporting_factors": [],
                    "contradicting_factors": [],
                    "historical_context_used": [],
            ...
            return {
                ...
                "approved": True,
                "confidence": 0.70,
                "reasoning": f"DeepSeek client error: {e}",
                "supporting_factors": [],
                "contradicting_factors": [],
                "historical_context_used": [],
